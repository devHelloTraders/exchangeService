package com.traders.exchange.web.rest.errors;
...
import com.traders.exchange.web.rest.model.FieldErrorVM;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.traders.exchange");
    }
}
