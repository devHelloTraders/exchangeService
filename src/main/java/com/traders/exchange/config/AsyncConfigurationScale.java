...
@Slf4j
public class AsyncConfigurationScale extends com.traders.common.config.AsyncConfiguration {
    private final ConfigProperties configProperties;

    public AsyncConfigurationScale(TaskExecutionProperties taskExecutionProperties, ConfigProperties configProperties) {
